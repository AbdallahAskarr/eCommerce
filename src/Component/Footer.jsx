        ...
        <footer className='style-2'  >
            ...
            <div className='footer-top dark-view padding-tb ' >
                <div className='container' >
                    <div className='row  row-cols-xl-4  row-cols-md-2 row-cols-1  justify-contentcenter' >
                        <div className="col">
            ...
            <div className='footer-bottom' >
                <div className='container' >
                    <div className='section-wrapper' >
                        <p>&copy; 2025 <Link to="/" >Shop Cart</Link>Developed By <a href="/" target='_blank'>Askar</a> </p>
